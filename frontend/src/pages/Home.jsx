function Home() {
  return (
    <div className="mx-8 my-8 grid grid-cols-1   grid-rows-2 gap-3 border-2 border-orange-700 md:grid-cols-3">
      <div className="border-8 border-green-500 md:col-span-2 md:row-span-2 ">
        <h1>What is Ecoway?</h1>
        <p>
          Ecoway is a platform that allows you to track your carbon footprint
          and offset it by donating to a charity of your choice.{' '}
        </p>
      </div>

      <div className="border-8 border-blue-500 md:col-start-3">
        ...
        <p>
          ...
          Finally, you will be able to offset your carbon footprint by donating
          to a charity of your choice.{' '}
        </p>
      </div>

      <div className="hidden border-8 border-red-500 md:col-start-3 md:row-start-2 md:flex">
        <h1>Why should I use Ecoway?</h1>
        <p>
          By using Ecoway, you will be able to track your carbon footprint and
          offset it by donating to a charity of your choice.{' '}
        </p>
      </div>
