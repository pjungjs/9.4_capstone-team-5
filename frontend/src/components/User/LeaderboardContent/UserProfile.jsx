...
function UserProfile({ userProfileData, index }) {
  ...
  return (
    <div className="relative w-72 rounded-b-xl md:w-96">
      <div
      ...
      >
        <div className="relative space-y-1 p-4">
          <p className="w-36 truncate text-xl md:w-60">
            {userProfileData.first_name} {userProfileData.last_name}
          </p>
          <div className="relative h-6 text-md text-blue-500">
            <span className="text-2xl transition duration-300 group-hover:invisible group-hover:opacity-0">
              {userPosition(index + 1)} Place
            </span>

            <p className="invisible absolute left-0 top-0 translate-y-3 items-center whitespace-nowrap pt-1 transition duration-300 group-hover:visible group-hover:translate-y-0">
              <span>Eco-Score: </span>
