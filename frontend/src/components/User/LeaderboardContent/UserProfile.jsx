...
function UserProfile({ userProfileData, userScores }) {
          ...
          <div key={userProfileData.id} className="flex">
              ...
              <div>
                <img
                  ...
                  <div>
              <p className="text-xl font-semibold">{userProfileData.name}</p>
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">{userProfileData.date}</p>
