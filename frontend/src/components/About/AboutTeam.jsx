...
function AboutTeam() { 
  ...
  <div className="mb-32 text-center">
    <p className="mb-12 text-3xl font-bold text-blue-600">
      Meet our team
    </p>

    <div className="lg:gap-xl-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4 text-blue-600">
      <div className="mb-12 lg:mb-0">
        <img className="mx-auto mb-6 rounded-lg shadow-lg dark:shadow-black/20 w-[150px]" src="https://media.licdn.com/dms/image/D4E03AQGku8AQcQseXQ/profile-displayphoto-shrink_200_200/0/1696047842285?e=1701302400&v=beta&t=88cctxUu_EuaNv4JquIwCvQdSDXOoe_A0vVs6moUONk" alt="avatar" />
      ...
      <div className="mb-12 lg:mb-0">
        <img className="mx-auto mb-6 rounded-lg shadow-lg dark:shadow-black/20 w-[150px]" src="https://ca.slack-edge.com/TCVA3PF24-U023WM3UPKN-40b80928e312-512" alt="avatar" />
      ...
      <div className="mb-12 md:mb-0">
        <img className="mx-auto mb-6 rounded-lg shadow-lg dark:shadow-black/20 w-[150px]" src="https://avatars.githubusercontent.com/u/115429022?v=4" alt="avatar" />
