...
VALUES
  ...
  ('2023-09-06T22:29:59.000Z', 'user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99', 'Jose', 'Cepeda', 'josecepeda', 'josecepeda@pursuit.org', 'Full Stack Web Developer', 'https://lh3.googleusercontent.com/a/ACg8ocIHEfs1bXismg-VnVSCEFr_mJtVuSCi3YhSLQuzf2_i=s96-c', '[
...
VALUES
  ('user-live-31e96c2c-329b-4bc2-9f26-8cdf394b3e37', 0, 350, 0, 0, 160, 0, 170, 780),
  ('user-live-211736d8-6627-48d5-b668-2bca308c4059', 7, 350, 0, 0, 350, 300, 0, 1007),
  ('user-live-683aaf5e-f190-4f08-ab20-d0ce6e82052e', 14, 350, 350, 100, 300, 0, 40, 1154),
  ('user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99', 30, 300, 300, 0, 10, 0, 300, 930),
  ('user-live-db28f083-5e3f-4159-9de8-6a91a07ac2cf', 7, 300, 300, 0, 0, 300, 40, 947);
...
VALUES 
  ...
  ('Energy-Efficiency Enthusiast', 'You have replaced all your traditional light bulbs with energy-efficient LEDs. Your home is lit with eco-friendly brilliance!', 'https://ecoway.s3.amazonaws.com/BadgesImages/energy+efficient+enthusiast.png', 300, 'energy' ),
  ('Carbon Footprint Wizard', 'Your energy-saving habits have reduced your carbon footprint, conserved precious resources equivalent to keep a small village sustainable, and shown others the power of green living.', 'https://ecoway.s3.amazonaws.com/BadgesImages/carbon+footprint+wizard.png', 400, 'energy'),
  ('Green Guru', 'You have reached a milestone in energy efficiency, power dynamo! Your commitment is like turning off 500 light bulbs for an entire year. Keep shining bright!', 'https://ecoway.s3.amazonaws.com/BadgesImages/green+guru.png', 475,'energy'),
  ...
  ('Green Master', 'Lifestyle Luminary! Your eco-conscious choices are like a beacon of sustainability. You have made a positive impact equivalent to planting 20 trees. Keep living the green life!', 'https://ecoway.s3.amazonaws.com/BadgesImages/green+Master.png', 300, 'lifestyle' ),
  ('Eco-Picasso', 'You have transformed into 10 works of art the equivalent of 20 pounds of recycled materials. Your creations are eco-masterpieces!', 'https://ecoway.s3.amazonaws.com/BadgesImages/eco+picasso.png', 400, 'lifestyle'),
  ('Eco-Bookworm', 'Your consitent habits shows your knowledge about gree living. Have you been in the library lately ? is like you have read 10 books on sustainability and eco-conscious living. Your mind is a garden of eco-ideas!', 'https://ecoway.s3.amazonaws.com/BadgesImages/eco+worm+book.png', 475, 'lifestyle' ),
  ...
  ('Bicycle Boss', 'Pedal Powerhouse! You have earned the Bicycle Boss badge. Your 100 miles on two wheels are like planting 10 trees along the bike path. Keep riding toward a greener tomorrow!', 'https://ecoway.s3.amazonaws.com/BadgesImages/Bicycle+Boss.png', 300, 'transportation'),
  ('Eco-Adventurer', 'Congratulations, Eco-Adventurer! Your sustainable travels have a carbon footprint lower than a trek through the wilderness. Keep exploring responsibly!', 'https://ecoway.s3.amazonaws.com/BadgesImages/eco+adventurer.png',400 ,'transportation'),
  ('Public transit trailblazer', 'Your commitment to public transportation has made city streets cleaner and traffic lighter. You are a pioneer of urban eco-commuting.', 'https://ecoway.s3.amazonaws.com/BadgesImages/public+transportation+trailblazer.png', 475, 'transportation'),
  ...
  ('Eco-Chef Connoisseur', 'You have cooked 30 plant-based meals. You are a culinary eco-genius!', 'https://ecoway.s3.amazonaws.com/BadgesImages/eco+chef+connoiseur.png', 300, 'food'),
  ('Zero Waste Foodie', 'You have taken zero-waste cooking to a whole new level. As a Zero-Waste Epicurean, your kitchen is a sustainability paradise! Your culinary efforts are equivalent to removing 500 pounds of CO2 from the atmosphere!', 'https://ecoway.s3.amazonaws.com/BadgesImages/zero+waste+foodie.png', 400, 'food'),
  ('Sustainable Sustainer', 'Your commitment to sustainable eating makes you a Sustainable Sustainer. Your food choices are as green as can be!  Your eco-conscious diet is equivalent to saving 100,000 gallons of water', 'https://ecoway.s3.amazonaws.com/BadgesImages/sustainable+sustainer.png', 475, 'food' );
...
VALUES
  ...
  ('2023-09-08T12:30:00Z', 'user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99', '{
    "Do you have a car?": true,
    "Do you use gas for cooking?": false,
    "Does your household use renewable energy?": "no",
    "How many large sized appliances have you purchased in the past year?": 4,
...
VALUES
  ('2023-09-08T12:30:00Z', 'user-live-31e96c2c-329b-4bc2-9f26-8cdf394b3e37', 'Welcome to EcoWay', 'welcome-to-ecoway', 'general', '', 'Welcome to EcoWay app. Let us pave a Sustainable Future, One EcoWay at a Time. You can reach us by submitting your message on the Contact Us page. It will really send us an email, so any feedback is much appreciated :)', '[
    ...
    { "user_id": "user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99", "liked_at": "2023-09-10T12:00:00Z" },
    ...
    { "user_id": "user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99", "commented_at": "2023-09-10T12:00:00Z", "content": "Looking forward using the app." },
  ...
  ('2023-09-08T14:00:00Z', 'user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99', 'Volunteer opportunity in NYC', 'volunteer-opportunity-in-nyc', 'resources', '', 'In New York City you can find several ecofriendly volunteer opportunities to share with others. The NYC Parks Stewardship Program offers tree planting, park cleanups, and habitat restoration projects. New York Cares, one of the citys largest volunteer organizations, has projects like urban gardening and community cleanups. GrowNYC focuses on environmental programs, including community gardens and recycling education. The Nature Conservancy - New York works to conserve natural areas and wildlife. Riverkeeper offers volunteer opportunities for river cleanups and water quality monitoring, particularly along the Hudson River. Lastly, the Sierra Clubs NYC Group organizes activities like hikes and cleanups for those interested in environmental conservation and advocacy. These organizations provide great avenues for individuals to contribute to a more ecofriendly NYC.', '[
    ...
    { "user_id": "user-live-9aeb3e25-314e-4d18-a516-d9a57319c9e99", "commented_at": "2023-09-10T12:00:00Z", "content": "I hope to see you guys there" }
  ]'),
